...
- **Windows Server:** A lightweight C++ background app using Winsock `AF_BTH` socket server. It decodes binary quaternion packets, processes movements through a 1 Euro Filter, and moves the pointer via Windows `SendInput`.
